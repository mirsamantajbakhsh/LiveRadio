...
jint Java_ir_mstajbakhsh_liveaudio_ShoutOutputStream_jniSend(JNIEnv *env, jobject obj, jbyteArray array, jint lengthOfArray) {
...
jint Java_ir_mstajbakhsh_liveaudio_ShoutOutputStream_jniInit(JNIEnv*  env,jobject  this,jstring urlservercast,jint puertocast,jstring montajecast,jstring usuariocast,jstring passwdcast) {
...
jint Java_ir_mstajbakhsh_liveaudio_ShoutOutputStream_jniClose(JNIEnv* env, jobject obj) {
	close_shout();
	return 1;
}